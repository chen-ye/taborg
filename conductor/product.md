...
- **Flexible LLM Integration:** Support for Google Gemini API and any OpenAI-compatible API (including local models like Ollama) with configurable model selection.
